...
Follow-up iteration on the converged production candidate, per design-lead feedback. Three moves: a new nav, an interactive hero built from the _real_ product UI, and a US map visualization.
