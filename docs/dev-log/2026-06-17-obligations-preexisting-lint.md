...
*without* listing it. Swapped the dep array to match actual usage
...
*other* dep changing, the row-open closure would navigate with stale search params.
...
provably safe at runtime. It is a tolerated *warning* (not an error); rewriting the
