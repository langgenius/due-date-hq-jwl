...
- `apps/app/src/features/obligations/obligation-type.ts` *(new)* — `tabsForObligationType`,
...
- `scripts/lifecycle-v2-status-backfill.sql` *(new)*
- `docs/dev-log/2026-05-20-obligation-drawer-redesign.md` *(new)*
