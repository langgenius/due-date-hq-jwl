...
- Expanded count badges stay as compact mono pills. Collapsed unread indicators are separate 6px dots rendered by the nav item, so the expanded badge pill never morphs into a dot.
