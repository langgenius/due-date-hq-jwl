...
| **ink**   | the colored **text** token, AA ≥ 4.5:1 on white *and* on the wash | as a large fill (too dark, reads as chrome) |
...
- **Solid ≠ text.** If you need colored text, use the family's **ink**. The
  ...
  accent and *does* carry white text on primary buttons, at 8.85:1.)
