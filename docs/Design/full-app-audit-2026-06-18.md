...
| P1     | `features/members/members-page.tsx:216,224,231,238` | 4 mutations (role/suspend/reactivate/remove) have no `onError` → silent failure          | add `onError: toast.error(...)`                          |
