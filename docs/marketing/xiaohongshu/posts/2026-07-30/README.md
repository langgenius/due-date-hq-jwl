...
今天两条:①**本周待办 digest**(重点:华盛顿 8月5日 只剩 6 天)②路易斯安那 Tropical Storm Arthur alert。
X 今天发布的镜像条(北卡 May 1→Sep 25, **2025**)是去年旧变更、截止日已过,不搬运;明天镜像阿拉巴马 MFCO(10/1/2026 生效,今日已进 X 审批队列)。

**小红书**:digest 发单图 `weekly-agenda-2026-07-30.png`;LA 发 3 页轮播 `-cover → -p1 → -p2`。
**LinkedIn = 文档帖(PDF)**:digest 传 `weekly-li-carousel-2026-07-30.pdf`(2 页),LA 传 `louisiana-…-li-carousel.pdf`(3 页);链接放首条评论。

---

## ① 本周待办 · IRS 延期全清单(11 条现行)

**小红书标题**:`本周待办⏰华盛顿只剩 6 天|IRS 延期全清单`

**小红书配文**

```
IRS 报税延期本周清单,按截止日排。最紧的是华盛顿:8月5日,只剩 6 天。

【本周清单】
· 8月5日 —— 华盛顿(风暴洪水)⏰ 还剩 6 天
· 8月20日 —— 佐治亚(野火)、夏威夷(风暴洪水)
· 9月28日 —— 亚利桑那(San Carlos Apache)、蒙大拿(Fort Peck / Crow 两条)
· 11月2日 —— 路易斯安那、密歇根、密西西比、北马里亚纳、威斯康星

共 11 条现行,每条都转录自 IRS 官方公告。有客户在这些州的会计师,先收藏对照。
...
```
IRS disaster relief — every open federal tax deadline extension, ranked (Jul 30, 2026).
All 11 IRS tax-deadline postponements in effect right now, closest first: Aug 5 — Washington (severe storms & flooding, 6 days out) · Aug 20 — Georgia (wildfires), Hawaii (storms & flooding) · Sep 28 — Arizona (San Carlos Apache Tribe), Montana (Fort Peck), Montana (Crow) · Nov 2 — Louisiana (Tropical Storm Arthur), Michigan, Mississippi, Northern Mariana Islands (Typhoon Sinlaku), Wisconsin. If you have clients anywhere on this list, their federal deadlines have moved. Every entry is transcribed from the official IRS release.
Which states are your clients in? Follow for the updated list each week — this is what we monitor at DueDateHQ.
