...
周五 = 本周最后工作日,过完周末离华盛顿 8月5日 截止只剩周一周二。所以今天主打:
①**华盛顿 8/5 最后提醒**(封面即倒计时)②蒙大拿 Crow 部落(和昨天 Fort Peck 是不同部落的独立公告)。
③若 X 今天如期发布阿拉巴马 MFCO(10/1/2026 生效)且事实核实无误,可加做镜像 —— 生成时用 `card-renderer`,别直接搬 X teaser。

**小红书**:各发 3 页轮播 `-cover → -p1 → -p2`。**LinkedIn = 文档帖(PDF)**;链接放首条评论。
数据修正:WA 实务提示第 4 点从「另含 Samish 部落领地」改为「24 县 + 25 个部落领地」(Samish 是部落非县,库内 07-28 已核实)。

---

## ① 华盛顿 · 8月5日 最后提醒(WA-2025-03)

**小红书标题**(主推):`离华盛顿 8月5日 截止,只剩 3 个工作日`
(备选:`华盛顿8/5截止:5天里隔着一个周末` / `有华盛顿客户的,这周别急着收工`)

**小红书配文**

```
华盛顿 24 县 + 25 个部落领地,联邦报税 8月5日(下周三)截止。日历上剩 5 天,中间隔着一个周末 —— 实际只剩今天、周一、周二,3 个工作日。

【核对清单】
· 客户地址落在 24 县 + 25 个部落领地内的:自动适用,无需申请
· 还没报完的:1040、1120 / 1120-S / 1065、1041、990、941 / 940、季度预缴
· 县外但账册或记账人在县内的:需致电 IRS 灾害热线,建议赶在周末前
· 完整名单:irs.gov 公告 WA-2025-03

【前情提要】
2025 年 12月9日 起,华盛顿发生风暴、洪水、山体滑坡灾害。IRS 发布灾害减免(WA-2025-03),受灾期内到期的联邦申报与缴款延至 2026 年 8月5日 —— 已是最后期限,不会再延。
...
**LinkedIn 文档标题**:`Washington IRS Tax Deadline: 5 Days to Aug 5, 2026 (WA-2025-03)`

**LinkedIn 配文**(发**文档帖**:上传 `wa-final-2026-07-31-li-carousel.pdf`)
