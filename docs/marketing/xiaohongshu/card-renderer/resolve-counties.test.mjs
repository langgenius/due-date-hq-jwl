...
eq('VA 独立市+同名县全称', resolveCounties('VA', ['Richmond city', 'Richmond County']), [
  '51760',
  '51159',
])
eq('VA 裸名歧义→报错', resolveCounties('VA', ['Richmond']), [], 1)
eq('VA Fairfax 市县歧义→报错', resolveCounties('VA', ['Fairfax']), [], 1)
eq('MD Baltimore 市/县', resolveCounties('MD', ['Baltimore city', 'Baltimore County']), [
  '24510',
  '24005',
])
eq('MO St. Louis 市/县', resolveCounties('MO', ['St. Louis city', 'St. Louis County']), [
  '29510',
  '29189',
])
