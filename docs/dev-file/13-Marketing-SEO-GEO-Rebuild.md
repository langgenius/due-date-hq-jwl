...
- [ ] **host 规范化**：加 Cloudflare `_redirects` 做 301 www→apex、http→https（`site.ts` canonical 已锚 apex）。
...
| sitemap / host | `astro.config.mjs`, `public/_headers`, 新增 `public/_redirects`                           |
