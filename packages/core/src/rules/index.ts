...
const STATE_ADDITIONAL_RULE_SOURCE_SEEDS = [
  ...
  },
  {
    ...
    title: 'Idaho Department of Labor Employer Portal',
    url: 'https://www.labor.idaho.gov/dnn/Businesses/Unemployment-Insurance-Taxes',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: ['ui_wage_report'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
  ...
  },
  {
    ...
    title: 'Louisiana Workforce Commission Employer UI Tax',
    url: 'https://www.laworks.net/FAQs/FAQ_UI_EmployerTax.asp',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: ['ui_wage_report'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
  ...
  },
  {
    ...
    title: 'Maine Department of Labor Unemployment Tax',
    url: 'https://www.maine.gov/unemployment/tax/',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: ['ui_wage_report'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
  ...
  },
  {
    ...
    title: 'Minnesota UI Wage Detail Report Due Dates',
    url: 'https://uimn.org/employers/wages-taxes/reports-payments/due-dates.jsp',
    sourceType: 'due_dates',
    acquisitionMethod: 'manual_review',
    domains: ['ui_wage_report'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
  ...
  },
  {
    ...
    title: 'Mississippi DOR Electing Pass-Through Entity FAQs',
    url: 'https://www.dor.ms.gov/business/corporate-income-and-franchise-tax-faqs',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
  ...
  },
  {
    ...
    title: 'Mississippi Department of Employment Security Employer Services',
    url: 'https://mdes.ms.gov/employers/',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: ['ui_wage_report'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
  ...
  },
  {
    ...
    title: 'Missouri Labor Quarterly Contribution and Wage Report',
    url: 'https://labor.mo.gov/des/employers/quarterly-contribution-and-wage-report',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: ['ui_wage_report'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
  ...
  },
  {
    jurisdiction: 'MT',
    id: 'mt.tax_due_dates',
    title: 'Montana Department of Revenue Tax Due Dates',
    url: 'https://mtrevenue.gov/tax-due-dates/',
    sourceType: 'due_dates',
    acquisitionMethod: 'manual_review',
    domains: [
      'fiduciary_income_return',
  ...
  },
  {
    jurisdiction: 'NH',
    id: 'nh.business_tax',
    title: 'New Hampshire DRA Business Tax',
    url: 'https://www.revenue.nh.gov/businesses/business-tax',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: [
      'business_income_return',
  ...
  },
  {
    ...
    title: 'New Hampshire Employment Security Employer Tax Rates',
    url: 'https://www.nhes.nh.gov/services/employers/tax-rate.htm',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: ['ui_wage_report'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
  ...
  },
  {
    jurisdiction: 'ND',
    id: 'nd.sales_use_tax',
    title: 'North Dakota Sales and Use Tax',
  ...
  },
  {
    ...
    title: 'North Dakota Income Tax Withholding',
  ...
  },
  {
    ...
    title: 'Oklahoma Employment Security Commission Employer Portal',
  ...
  },
  {
    jurisdiction: 'VT',
    id: 'vt.tax_due_dates',
    title: 'Vermont Department of Taxes Due Dates',
    url: 'https://tax.vermont.gov/individuals/personal-income-tax/filing',
    sourceType: 'due_dates',
    acquisitionMethod: 'manual_review',
    domains: [
      'individual_estimated_tax',
  ...
  },
  {
    ...
    title: 'WorkForce West Virginia Employer Handbook',
    url: 'https://workforcewv.org/wp-content/uploads/2025/02/Employer-Handbook-Rev.-02.25.pdf',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: ['ui_wage_report'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
  ...
  },
  {
    jurisdiction: 'WY',
    id: 'wy.sales_use_tax',
    title: 'Wyoming DOR Sales and Use Tax Division',
    url: 'https://revenue.wyo.gov/divisions',
    sourceType: 'instructions',
    acquisitionMethod: 'manual_review',
    domains: ['sales_use_tax'],
    entityApplicability: ['sole_prop', 'llc', 'partnership', 's_corp', 'c_corp'],
