...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        'mb-3 font-medium text-text-primary data-[variant=label]:text-sm data-[variant=legend]:text-base',
        className,
      )}
      {...props}
    />
  ...
  return (
    <Label
      ...
      className={cn(
        ...
        'has-data-checked:border-state-accent-solid/30 has-data-checked:bg-state-accent-hover',
        'has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border has-[>[data-slot=field]]:border-divider-regular *:data-[slot=field]:p-3',
...
function FieldTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        'flex w-fit items-center gap-2 text-sm font-medium text-text-primary',
        'group-data-[disabled=true]/field:opacity-50',
        className,
      )}
      {...props}
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        'relative -my-2 h-5 text-sm text-text-tertiary group-data-[variant=outline]/field-group:-mb-2',
        className,
      )}
      {...props}
    >
      ...
      {children && (
        <span
          className="relative mx-auto block w-fit bg-background-default px-2 text-text-tertiary"
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn('text-sm font-normal text-text-destructive', className)}
      {...props}
    >
      {content}
    </div>
