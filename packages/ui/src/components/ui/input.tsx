...
/**
 * Base input. Visual baseline matches DESIGN.md: h-9, rounded-xl,
...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        'flex h-9 w-full min-w-0 items-center rounded-xl border border-divider-regular bg-components-input-bg-normal px-3 py-1 text-sm text-components-input-text-filled outline-none transition-colors',
