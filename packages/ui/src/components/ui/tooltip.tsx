      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            ...
            'inline-flex w-fit max-w-xs items-center gap-1.5 rounded-xl border border-components-panel-border bg-components-tooltip-bg px-3.5 py-2.5 text-xs font-medium leading-snug text-components-tooltip-text shadow-lg backdrop-blur-[6px]',
