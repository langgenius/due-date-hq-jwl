# DueDateHQ — CPA Newsletter Outreach Pack

Two tracks. Don't mix them — the ask and the tone are different.

- **Track 1 — Creators (sponsored mention / classified):** warm, personalized, offer a free account. These are the best fit for DueDateHQ's buyer.
- **Track 2 — Publications (request media kit):** short inbound request for rates. Don't cold-pitch these; just ask for the kit.

**Batch-emailable right now:** Jason Staats (jason@jasononfirms.com), AICPA ad sales (adsales@aicpa-cima.com), CPA Practice Advisor (editor@cpapracticeadvisor.com).
**Manual (form / media-kit page — not emailable):** Future Firm, Blake Oliver, CPA Trendlines, Going Concern, Accounting Today.
...
- CPA Trendlines — cpatrendlines.com
- Going Concern — goingconcern.com (Tue + Fri sends)
...
## Template B — Publication media-kit request (Track 2)

Tokens: `{{team}}`, `{{publication}}`, `{{link}}`
...
> Hi {{team}},
>
> I'd like to advertise in {{publication}}. I'm the co-founder of DueDateHQ — we monitor filing-deadline changes for US CPA firms (IRS, all 50 states, and FEMA) and flag which clients each change hits.
>
...
**Ryan Lazanis (Future Firm)** — via futurefirm.co/contact
