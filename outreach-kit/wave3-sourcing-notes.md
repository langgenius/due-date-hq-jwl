...
- **3 flagged for your review** (`wave3-review-fit.csv`) — surfaced, not deleted, so you decide:
  - _Welch, Couch & Company PA_ (AR) — public accounting **+ wealth management** hybrid.
  - _Julie Duda CPA_ (CA) — solo, IRS-resolution-leaning, no business-entity work.
  - _ProActive Tax CPA_ (MT) — site says **not accepting new clients**.
