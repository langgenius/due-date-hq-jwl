      ...
      <PopoverTrigger
        render={
          <button
            ...
            disabled={disabled}
            className={cn(
              'flex h-9 w-full min-w-0 cursor-pointer items-center justify-between gap-2 rounded-xl border border-divider-regular bg-components-input-bg-normal px-3 py-1 text-sm text-components-input-text-filled transition-colors outline-none',
