  ...
  return (
    <span
      className={cn(
        ...
        // tall.
        'inline-flex h-[22px] items-center gap-1.5 rounded-full bg-state-destructive-hover px-2 text-sm leading-none font-medium text-text-destructive tabular-nums',
        className,
      )}
    >
