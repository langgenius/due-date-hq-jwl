// Dev-only mock seeder for Alerts + drawer. Activated by demo/e2e flows
...
export function seedAlertMock(queryClient: QueryClient): void {
  ...
  console.info(
    '[mock-alerts] seeded %d alerts. Open /alerts or the dashboard banner to verify.',
    ALERTS.length,
  )
}
