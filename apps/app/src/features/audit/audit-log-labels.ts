...
export function useAuditActionLabels(): AuditActionLabels {
  ...
  return useMemo(
    () => ({
      ...
      pulseApply: t`Radar applied`,
      pulseApprove: t`Radar approved`,
      pulseDismiss: t`Radar dismissed`,
      pulseExtract: t`Radar update extracted`,
      pulseIngest: t`Radar source ingested`,
      pulseQuarantine: t`Radar quarantined`,
      pulseReactivate: t`Radar reactivated`,
      pulseReject: t`Radar rejected`,
      pulseRevert: t`Radar reverted`,
      pulseReviewRequested: t`Radar review requested`,
      pulseSnooze: t`Radar snoozed`,
      pulseSourceRevoked: t`Radar source revoked`,
      ...
      obligationQueueExported: t`Obligations exported`,
...
export function useAuditEntityTypeLabels(): AuditEntityTypeLabels {
  ...
  return useMemo(
    () => ({
      ...
      pulseApplication: t`Radar application`,
      pulseAlert: t`Radar alert`,
      rule: t`Rule`,
    ...
    () => ({
      ...
      headlines: {
        ...
        pulseDueDateChanged: (previous, next) =>
          t`Radar changed due date from ${previous} to ${next}`,
