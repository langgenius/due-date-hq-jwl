...
export function useAuditActionLabels(): AuditActionLabels {
  ...
  return useMemo(
    () => ({
      ...
      authMfaChallengeVerified: t`Two-factor verified`,
      ...
      calendarSubscriptionCreated: t`Calendar feed created`,
      calendarSubscriptionRegenerated: t`Calendar feed link rotated`,
      calendarSubscriptionDisabled: t`Calendar feed revoked`,
      clientArchived: t`Client archived`,
      ...
      clientRestored: t`Client restored`,
      ...
      readinessMaterialsReceived: t`Materials received`,
      readinessPortalOpened: t`Client opened materials link`,
      readinessClientResponse: t`Client submitted materials`,
      obligationBatchCreated: t`Deadlines created`,
      obligationDueDateUpdated: t`Internal deadline changed`,
      obligationStatusAutoUnblocked: t`Deadline auto-unblocked`,
      obligationBlockedBySet: t`Deadline blocked`,
      obligationBlockedByCleared: t`Deadline unblocked`,
      obligationPrepStageUpdated: t`Prep stage changed`,
      obligationReviewStageUpdated: t`Review stage changed`,
      obligationEfileStateUpdated: t`E-file status changed`,
      obligationEfileRejected: t`E-file rejected`,
      ...
      pulseReviewed: t`Alert reviewed`,
      pulseSourceRevoked: t`Alert source revoked`,
      reminderBounced: t`Reminder bounced`,
      reminderFailed: t`Reminder couldn't be sent`,
      reminderOpened: t`Reminder opened`,
      reminderSent: t`Reminder sent`,
      reminderTemplateUpdated: t`Reminder template edited`,
      reminderUnsubscribed: t`Client unsubscribed`,
...
export function useAuditEntityTypeLabels(): AuditEntityTypeLabels {
  ...
  return useMemo(
    () => ({
      ...
      calendarSubscription: t`Calendar feed`,
      client: t`Client`,
      clientBatch: t`Client import batch`,
      clientEmailSuppression: t`Email unsubscribe`,
      firm: t`Practice`,
      ...
      pulseAlert: t`Alert`,
      reminderTemplate: t`Reminder template`,
      rule: t`Rule`,
  ...
  return useMemo(
    () => ({
      ...
      fields: {
        ...
        applicableYear: t`Filing year`,
        assigneeName: t`Assignee`,
        bodyTextChanged: t`Message body changed`,
        cells: t`Rule cells`,
        ...
        extensionPolicy: t`Extension`,
        failureReason: t`Why it failed`,
        fileCount: t`Files`,
        fileName: t`File`,
        format: t`Format`,
        formName: t`Form`,
        ...
        templateKey: t`Reminder template`,
        timezone: t`Timezone`,
