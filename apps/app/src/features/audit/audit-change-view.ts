...
export const AUDIT_CHANGE_PRESENTERS: Record<KnownAuditAction, AuditChangePresenter> = {
  ...
  'client.archived': genericPresenter,
  ...
  'client.restored': genericPresenter,
  'client.filing_profiles.replaced': genericPresenter,
  'client.jurisdiction.updated': genericPresenter,
  'client.risk_profile.updated': genericPresenter,
  'client.source_details.updated': genericPresenter,
  'client.tax_year_profile.updated': genericPresenter,
