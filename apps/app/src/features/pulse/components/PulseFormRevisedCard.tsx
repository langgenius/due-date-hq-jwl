...
function PulseFormRevisedCard({ alert, onReview, facts, className }: PulseFormRevisedCardProps) {
  ...
  const detailQuery = useQuery(usePulseDetailQueryOptions(alert.id))
          ...
          <div className="flex flex-col gap-1.5 px-4 py-3">
            ...
            <div className="flex items-center gap-2.5 text-sm">
              ...
              {facts?.whatChanged?.newBadge ? (
                ...
                // slight rotation.
                <span
                  className="inline-flex shrink-0 -rotate-[11deg] items-center rounded-full bg-[#92400E] px-2 py-[3px] font-mono text-[10px] font-bold tracking-[0.7px] text-white"
