...
/**
 * Canonical tone selector for a Pulse alert — single source of truth
 ...
 * implementations (NeedsAttentionCard / PulseAlertCard /
 * PulseDetailDrawer) onto this helper. The drawer's old helper
 ...
 *
 * Pair with `pulseAlertTone()` so the colour and the sentence
 * always agree.
 */
