      ...
      <PreviewGroupHeader
        ...
        label={
          <ConceptLabel concept="reminderReady">
            {reminderReady.length === 1
              ? t`REMINDER READY — 1 deadline, will fire 30 / 7-day reminders`
              : t`REMINDER READY — ${reminderReady.length} deadlines, will fire 30 / 7-day reminders`}
          </ConceptLabel>
        }
      />
