...
const zhCN: LandingCopy = {
  ...
  pricing: {
    ...
    hero: {
      ...
      title: '随事务所成长的简单定价。',
      description:
        'DueDateHQ 7×24 盯着 IRS、全部 50 个州和 FEMA，让你的事务所在第一时间抓住每一次截止日变更，并精确知道它影响到哪些客户。先免费用 3 个月 Team 版——无需信用卡——之后再随着客户和团队的增长，选好合适的套餐。',
      note: '先免费用 3 个月 Team 版 · 用 Google 登录 · 我们不保存卡号',
    },
    plansHeader: {
      eyebrow: '套餐',
      title: '按你监控的客户数量计费。',
      note: '美元定价 · 由事务所所有者付费 · 随时取消',
    },
    billingToggle: {
      ariaLabel: '账单周期',
      monthly: '月付',
    ...
    faq: [
      {
        question: '有免费试用吗？',
        answer:
          '有 —— 前 3 个月的 Team 版免费，开始无需信用卡。你可以把真实事务所跑起来，之后再按客户数量选好合适的套餐；套餐随时可以更换。',
      },
      {
        question: '我该从哪个套餐开始？',
        answer:
    ...
    comingSoonFaq: [
      {
        question: 'DueDateHQ 会收多少钱？',
        answer:
          '套餐尚未最终确定，所以我们不会报一个之后可能更改的价格。我们会在你的免费月份结束前把价格公布在这里，并且在你主动选择套餐之前绝不收费。',
      },
      {
        question: '有免费试用吗？',
        answer:
          '比试用更好——前 3 个月的 Team 版免费，开始无需信用卡。你可以把真实事务所跑起来，再按客户数量选好合适的套餐。',
      },
      {
        question: '开始需要信用卡吗？',
        answer:
          '不需要。免费开始、无需信用卡——我们从不保存卡号，只有当你选择付费套餐时才会开始计费。',
      },
      {
        question: '定价公布后会怎样？',
        answer: '我们会在你的免费月份结束前把各套餐公布在这里，由你决定是否继续，不会自动扣费。',
      },
    ],
  },
  geo: {
    ...
    stateCoverage: {
      ...
      hero: {
        ...
        description:
          'DueDateHQ 跨全部 50 州和 DC 监控 IRS 与各州税务机关官方页面，捕捉规则与申报日期的变化。每条变化都带来源链接与摘录，先经复核才会影响客户截止日——全面、可追溯、可核验，不是黑盒。',
