---
name: optimize-ui
description: Diagnose and fix UI performance: identify the actual bottleneck (rendering, motion smoothness, load time, bundle size), fix it, then measure. Use when an interface feels slow, janky, or heavy.
---
