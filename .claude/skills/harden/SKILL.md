---
name: harden
description: Harden an interface against real-world inputs: extreme text lengths, emoji/RTL, huge lists, empty states, network failures, API errors, i18n expansion, and concurrent operations. Use when making UI production-ready or reviewing edge-case coverage.
---
